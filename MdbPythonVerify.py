...
# using the just installed mariadb python connector interface
...
print("This is version {0} Python/connector".format(res[0]))
...
print("The current user is: {0}".format(res[0]))

res = ExecMariaDBcmd("SHOW TABLES FROM test")
print("The database 'test' contains {0}".format(res[0]))
...
print('cursor.execute("INSERT INTO books VALUES(44,'+"'MariaDB tutorial 44'," +' 44)")')
print('cursor.execute("INSERT INTO books VALUES(55,'+"'MariaDB tutorial 55'," +' 55)")')

cursor.execute("INSERT INTO books VALUES(44, 'MariaDB tutorial 44', 44)")
connection.commit()
cursor.execute("INSERT INTO books VALUES(55, 'MariaDB tutorial 55', 55)")
connection.commit()
